...
def input_network(weights_initializer, state):
  ...
  velocity_net = slim.conv3d(
      velocity_net, 32, [2, 3, 3], stride=(1,2,2), weights_initializer=weights_initializer)
  velocity_net = slim.conv3d(
      velocity_net, 64, [1, 3, 3], stride=(1,2,2), weights_initializer=weights_initializer)      
  velocity_net = slim.conv3d(
      velocity_net, 64, [1, 3, 3], stride=(1,2,2), weights_initializer=weights_initializer)     
  velocity_net = slim.flatten(velocity_net)
  velocity_net = slim.fully_connected(velocity_net, 64, activation_fn=None)
  ...
  pelvis_net = slim.conv1d(pelvis_net, 16, 3, stride=2, weights_initializer=weights_initializer)
  pelvis_net = slim.conv1d(pelvis_net, 16, 2, stride=1, weights_initializer=weights_initializer)
  pelvis_net = slim.flatten(pelvis_net)
  pelvis_net = slim.fully_connected(pelvis_net, 4, activation_fn=tf.nn.relu6)

  l_leg = tf.slice(all_net, [0,246,0], [batch_size,22,stack_size])
  l_leg = slim.conv1d(l_leg, 16, 4, stride=3, weights_initializer=weights_initializer)
  l_leg = slim.conv1d(l_leg, 32, 3, stride=2, weights_initializer=weights_initializer)
  l_leg = slim.conv1d(l_leg, 32, 2, stride=1, weights_initializer=weights_initializer)
  ...
  r_leg = slim.conv1d(r_leg, 16, 4, stride=3, weights_initializer=weights_initializer)
  r_leg = slim.conv1d(r_leg, 32, 3, stride=2, weights_initializer=weights_initializer)
  r_leg = slim.conv1d(r_leg, 32, 2, stride=1, weights_initializer=weights_initializer)
...
def nature_dqn_network(num_actions, network_type, state):
  ...
  net = input_network(weights_initializer, state)
...
def implicit_quantile_network(num_actions, quantile_embedding_dim,
  ...
  state_net = input_network(weights_initializer, state)
